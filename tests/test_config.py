...
# Agent IDs
HOSTING_AGENT_ID = os.environ.get("HOSTING_AGENT_ID", "7540524410566868992")
COCKTAIL_AGENT_ID = os.environ.get("COCKTAIL_AGENT_ID", "7965234966051160064")
WEATHER_AGENT_ID = os.environ.get("WEATHER_AGENT_ID", "8434488936599912448")
